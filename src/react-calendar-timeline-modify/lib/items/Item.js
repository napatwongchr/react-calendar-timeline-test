...
export default class Item extends Component {
    ...
    interact(this.item)
      ...
      .on("dragmove", e => {
        ...
        if (this.props.dragging) {
          if (e.dropzone) {
            ...
            if (
              dragTime !==
              _get(this.props.item, this.props.keys.itemTimeStartKey)
            ) {
      ...
      .on("resizemove", e => {
        ...
        if (this.props.resizing) {
          ...
          const isResizeTimeChangedRight =
            resizeEdge === "right" &&
            resizeTime !==
              _get(this.props.item, this.props.keys.itemTimeEndKey);
          const isResizeTimeChangedLeft =
            resizeEdge === "left" &&
            resizeTime !==
              _get(this.props.item, this.props.keys.itemTimeStartKey);
  ...
  render() {
    ...
    const itemContext = {
      ...
      resizeTime:
        this.props.resizeEdge !== undefined
